...
foreach ( array( 'pre_term_name', 'pre_comment_author_name', 'pre_link_name', 'pre_link_target', 'pre_link_rel', 'pre_user_display_name', 'pre_user_first_name', 'pre_user_middle_name', 'pre_user_last_name', 'pre_user_nickname' ) as $filter ) {
...
foreach ( array( 'term_name', 'comment_author_name', 'link_name', 'link_target', 'link_rel', 'user_display_name', 'user_first_name', 'user_middle_name', 'user_last_name', 'user_nickname' ) as $filter ) {
	if ( is_admin() ) {
